# Documentação do ScalePass

## Produto e desenvolvimento

- [Arquitetura atual](architecture.md)
- [Domínio e regras funcionais](domain.md)
- [Desenvolvimento local](development.md)
- [Decisões arquiteturais](decisions/README.md)

## Evolução técnica

- [Roteiro geral](studies/roadmap.md)
- [Backlog direcionado](studies/challenge-backlog.md)
...
- [Desafio ativo: dashboard Prometheus e Grafana](studies/challenges/010-prometheus-grafana-dashboard/README.md)
